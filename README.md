...
clear all the room properties. This will triger a server response broadcasting the empty properties.
...
Requests the current properties of the room. Use a callback or register a 'get_room_properties' message handler before dispatching the message. Note: the room properties are also included in the server response after succesfully joining a room.
